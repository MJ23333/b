...
I、III：等温可逆：
$$
\begin{gather*}W_1=-Q_{\rm h}=-nRT_{\rm h}\ln\frac{V_2}{V_1}\\\\W_3=-Q_{\rm c}=-nRT_{\rm c}\ln\frac{V_4}{V_3}\end{gather*}
$$
II、IV：绝热可逆（认为热容不变）：
$$
...
$$
\begin{gather*}\eta=\frac {{\color{red}-}W}{Q_{\rm h}}=\frac W{W_1}=\frac{T_{\rm h}-T_{\rm c}}{T_{\rm h}}=1-\frac{T_{\rm c}}{T_{\rm h}}\\\\\eta=\frac {Q_{\rm h}+Q_{\rm c}}{Q_{\rm h}}=1+\frac {Q_{\rm c}}{Q_{\rm h}}\end{gather*}
$$
